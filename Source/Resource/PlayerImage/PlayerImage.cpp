...
namespace res {
	...
	void PlayerImage::load() {
		...
		lib::Graphics2D::loadSplit("./dat/image/Player/03.png", 12, 4, 3, 160, 160, Player.type[PLAYER_TYPE::HIME]);
		lib::Graphics2D::loadSplit("./dat/image/Player/04.png", 12, 4, 3, 160, 160, Player.type[PLAYER_TYPE::IORIKO]);
