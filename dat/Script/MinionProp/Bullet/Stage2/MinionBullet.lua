dofile('./dat/Script/MinionProp/Bullet/Stage2/Pattern/at0.lua')
dofile('./dat/Script/MinionProp/Bullet/Stage2/Pattern/at1.lua')
dofile('./dat/Script/MinionProp/Bullet/Stage2/Pattern/at2.lua')
dofile('./dat/Script/MinionProp/Bullet/Stage2/Pattern/at3.lua')
dofile('./dat/Script/MinionProp/Bullet/Stage2/Pattern/at4.lua')
dofile('./dat/Script/MinionProp/Bullet/Stage2/Pattern/at5.lua')
...
function MinionBulletUpdate(id)
	...
	if(Minion.getBulletID(id) == 5)then Bullet5(id) end
end
function MinionBulletTrans()
	for bl_num = 0, SHOT_MAX do
		if(Shot.isFlag(bl_num))then
			...
			if(Shot.getState1(bl_num) == 5)then Trans5(bl_num) end
		end
	end
end
